  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: 'AI株式診断サービスとは何ですか？',
          a: '実際のAI技術を使用して株式市場の情報を分析し、無料で教育・学習用の参考情報を提供するサービスです。金融商品の売買推奨や投資助言は一切行いません。'
        },
        {
          q: '無料で利用できますか？',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'AI診断の精度はどのくらいですか？',
          a: '実際のAI処理による分析ですが、教育・学習用の参考情報であり、将来の株価を予測したり、投資成果を保証するものではありません。'
        },
        {
          q: '提供される情報は投資に使えますか？',
          a: '当サービスは無料の教育・学習用参考情報のみを提供します。投資助言、投資推奨、金融商品の売買推奨を一切行いません。最終的な投資判断は必ずご自身の責任で行ってください。'
        },
        {
          q: 'どのような情報を基に分析していますか？',
          a: '公開市場情報（準リアルタイム）を使用して、実際のAI技術で分析した結果を教育・学習用の参考情報として提供します。突発的なニュースや市場環境の急変には対応できません。'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          a: 'いいえ、当サービスは無料のAI診断ツールであり、金融商品取引業者ではありません。投資助言業務、投資推奨、金融商品仲介業務、金融商品の売買推奨を一切行いません。'
        },
        {
          q: '投資助言を受けることはできますか？',
          a: '当サービスは投資助言・推奨を一切行いません。教育・学習用の参考情報のみを無料で提供しています。投資相談が必要な場合は、登録投資助言業者や証券会社にご相談ください。'
        }
      ]
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-900 font-artistic">よくある質問（FAQ）</h1>
          </div>
